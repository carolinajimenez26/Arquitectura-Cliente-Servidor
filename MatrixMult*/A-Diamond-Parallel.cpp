...
bool compare(SafeGraph &m1, SafeGraph &m2) {
...
int main(int argc, char **argv) {
  ...
  // dbg(workers);
  cout << "---------Final Graph (thread_pool)----------" << endl;
  g.print();

  // Parallel implementation
  workers = parallelMult2(h.getNodes(), original, h, r);
  cout << "---------Final Graph (vector of threads)----------" << endl;
  h.print();
